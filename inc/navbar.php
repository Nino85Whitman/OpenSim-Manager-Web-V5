...
<div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                   <i class="glyphicon glyphicon-info-sign"></i> Infos <span class="caret"></span>
                </a>
                <ul class="dropdown-menu">
                    <li <?php if ($_GET['a'] == 7) {echo 'class="active"';} ?>>
                        <a href="index.php?a=7"> <i class="glyphicon glyphicon-th-list"></i> Logs</a>
                    </li>
                    <li <?php if ($_GET['a'] == 13) {echo 'class="active"';} ?>>
                        <a href="index.php?a=13"><i class="glyphicon glyphicon glyphicon-book"></i> Manual</a>
                    </li>
                    ...
                    <li <?php if ($_GET['a'] == 9) {echo 'class="active"';} ?>>
                        <a href="index.php?a=9"><i class="glyphicon glyphicon-phone-alt"></i> Contact</a>
                    </li>
                </ul>
            </li>
        ...
        <ul class="nav navbar-nav navbar-right">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
					 <li><a href="index.php?a=8"><i class="glyphicon glyphicon-check"></i> Modifier Compte</a></li>
